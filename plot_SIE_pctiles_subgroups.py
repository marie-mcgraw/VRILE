...
# -*- coding: utf-8 -*-
"""
Created on Tue Sep 10 13:42:56 2019
...
#region_names = ['East-Siberian-Beaufort-Chukchi',
#                'Kara-Laptev','Canadian Islands','Hudson Bay',
#                'panArctic','Central Arctic']
region_names = ['Barents Sea','East Greenland Sea','Baffin Bay','Bering',
                'Sea of Okhotsk','St John','panArctic']
...
ax1.legend(leg_handles,region_names,ncol=1,bbox_to_anchor=(1, 1.025))
...
fname_1 = '/home/disk/sipn/mcmcgraw/figures/VRILE/{model_name}_{model_type}_AND_obs_pctile5_WINTER_{day_change}day_change_{max_lead}day_lead_{filt_app}.png'.format(model_name=model_name,
                                                  model_type=model_type,day_change=day_change,max_lead=max_lead,
                                                  filt_app=filt_app)
...
ax2.legend(region_names,ncol=1,bbox_to_anchor=(1,1.025))
...
fname_2 = '/home/disk/sipn/mcmcgraw/figures/VRILE/{model_name}_{model_type}_model_minus_obs_pctile5_WINTER_{day_change}day_change_{max_lead}day_lead_{filt_app}.png'.format(model_name=model_name,
...
ax3.legend(leg_handles,region_names,ncol=1,bbox_to_anchor=(1, 1.025))
ax3.set_ylabel('%',fontsize=11)
ax3.set_title('Frequency that modeled SIE is below observed 5th percentile',fontsize=12)
fname_3 = '/home/disk/sipn/mcmcgraw/figures/VRILE/{model_name}_{model_type}_freq_model_below_obs_5pct_WINTER_{day_change}day_change_{max_lead}day_lead_{filt_app}.png'.format(model_name=model_name,
