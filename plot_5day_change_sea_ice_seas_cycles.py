...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 19 14:21:30 2019
...
choose_var_model = 'd_SIE (V - I)'
choose_var_obs = 'd_SIC (V - I)'
titlename_choose_var = '{day_change}-day change in '.format(day_change=day_change)
filename_choose_var = 'd_SIE'
...
for ireg in np.arange(0,len(regions)):
    ...
    ax1.set_title('{title_var} sea ice extent, {region} ({model_name} {model_type}), lead days: {lead_day}'.format(title_var=titlename_choose_var,
                  region=region_sel,
