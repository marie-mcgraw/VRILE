...
VAR_model = pd.read_csv(filepath+"{model_name}_{model_type}_variance_{day_change}day_change_lead_time_{max_lead}_days_ALL_ENS.csv".format(model_name=model_name,
              model_type=model_type,day_change=day_change,max_lead=max_lead))

p5_model = pd.read_csv(filepath+"{model_name}_{model_type}_variance_{day_change}day_change_lead_time_{max_lead}_days_ALL_ENS.csv".format(model_name=model_name,
              model_type=model_type,day_change=day_change,max_lead=max_lead))
