...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov 18 11:28:47 2019
...
#%%    
##load all model files. We'll stick with ecmwfsipn reforecast data here. 
##the ecmwfsipn folder refers to the ECMWF_C3S model data (NOT the S2S data)
model_name = 'ecmwf'
...
no_ensemble = filenames.ensemble
...
no_ens = len(no_ensemble) ##no. of ensemble members
...
for ireg in reg_sel:
    ...
    #itime = 0
        ...
        init_select = init_times_df[itime]#.to_dataset(name='initial_time')
        
        print('region ',region_name,'  ',init_select)
        #%%
    ...
    filename_full = filepath_save+'{model_name}_{model_type}_SIE_d_SIE_{d_days}day_change_lead_time_{region}_ALL_ENS.csv'.format(model_name=model_name,
                       model_type=model_type,d_days=no_day_change,region=region_name)
